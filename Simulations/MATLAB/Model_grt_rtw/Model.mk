...
## 
## Makefile     : Model.mk
## Generated on : Sun Dec 15 01:55:57 2024
...
START_DIR                 = C:/Users/Nabil/Desktop/SEMEST~1/ADVANC~1/Project/SIMULA~1/MATLAB
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
DEFINES_STANDARD = -DMODEL=Model -DNUMST=2 -DNCSTATES=9 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/Model_grt_rtw/Model.c $(START_DIR)/Model_grt_rtw/Model_data.c $(START_DIR)/Model_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.obj Model.obj Model_data.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/Model_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Model_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Model_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Model_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_nonfinite.obj : $(START_DIR)/Model_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
